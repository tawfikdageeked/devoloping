...
const char* GetEGLErrorString(EGLint error) {
    switch (error) {
        ...
        case EGL_BAD_ACCESS: return "EGL_BAD_ACCESS: EGL cannot access a requested resource.";
        case EGL_BAD_ALLOC: return "EGL_BAD_ALLOC: EGL failed to allocate resources for the requested operation.";
        case EGL_BAD_ATTRIBUTE: return "EGL_BAD_ATTRIBUTE: An unrecognized attribute or attribute value was passed.";
        ...
        case EGL_BAD_SURFACE: return "EGL_BAD_SURFACE: An EGLSurface argument does not name a valid surface.";
        case EGL_BAD_MATCH: return "EGL_BAD_MATCH: Arguments are inconsistent.";
        ...
        case EGL_CONTEXT_LOST: return "EGL_CONTEXT_LOST: A power management event has occurred. The application must destroy all contexts and reinitialise.";
